...
class TotalPane extends Pane {
	...
	DetailsPane detailsPane =null;//栈信息窗口
	...
	public void paint() {
		...
		detailsPane.setLayoutX(0);
		detailsPane.setLayoutY(310);
		
		
		functionPane.getChildren().addAll(text1, text2,text3);
